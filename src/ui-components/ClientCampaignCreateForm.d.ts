...
export declare type ClientCampaignCreateFormInputValues = {
    name?: string;
    description?: string;
    clientNotes?: string;
...
export declare type ClientCampaignCreateFormValidationValues = {
...
export declare type ClientCampaignCreateFormOverridesProps = {
    ClientCampaignCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ClientCampaignCreateFormProps = React.PropsWithChildren<{
    overrides?: ClientCampaignCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: ClientCampaignCreateFormInputValues) => ClientCampaignCreateFormInputValues;
    onSuccess?: (fields: ClientCampaignCreateFormInputValues) => void;
    onError?: (fields: ClientCampaignCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ClientCampaignCreateFormInputValues) => ClientCampaignCreateFormInputValues;
    onValidate?: ClientCampaignCreateFormValidationValues;
} & React.CSSProperties>;
export default function ClientCampaignCreateForm(props: ClientCampaignCreateFormProps): React.ReactElement;
