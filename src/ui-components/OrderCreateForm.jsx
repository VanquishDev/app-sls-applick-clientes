...
export default function OrderCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCouponID(initialValues.couponID);
    setCouponName(initialValues.couponName);
    setCouponDiscount(initialValues.couponDiscount);
    setDeliveryPrice(initialValues.deliveryPrice);
    setTotal(initialValues.total);
    setRating(initialValues.rating);
    setRatingNotes(initialValues.ratingNotes);
    setOrderPagarmeID(initialValues.orderPagarmeID);
    setAddressReference(initialValues.addressReference);
    setAddressStreet(initialValues.addressStreet);
    setAddressNumber(initialValues.addressNumber);
    setAddressComplement(initialValues.addressComplement);
    setAddressZipcode(initialValues.addressZipcode);
    setAddressNeighborhood(initialValues.addressNeighborhood);
    setAddressCity(initialValues.addressCity);
    setAddressState(initialValues.addressState);
    setAddressCountry(initialValues.addressCountry);
    setNotes(initialValues.notes);
    setAdherenceID(initialValues.adherenceID);
    setAdherenceName(initialValues.adherenceName);
    setAdherenceOrientation(initialValues.adherenceOrientation);
    setClientCampaignID(initialValues.clientCampaignID);
    setClientCampaignName(initialValues.clientCampaignName);
    setCompanyName(initialValues.companyName);
    setCompanyPhone(initialValues.companyPhone);
    setCompanyOpeningHours(initialValues.companyOpeningHours);
    setClientCampaignUnitID(initialValues.clientCampaignUnitID);
    setClientCampaignUnitName(initialValues.clientCampaignUnitName);
    setQrCodePix(initialValues.qrCodePix);
    setQrCodePixUrl(initialValues.qrCodePixUrl);
    setPayMethod(initialValues.payMethod);
    setInstallments(initialValues.installments);
    setHomeCareOrRetail(initialValues.homeCareOrRetail);
    setErrors({});
  };
  const validations = {
